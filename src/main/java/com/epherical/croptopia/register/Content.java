...
public class Content {
    ...
    public static void registerItems(RegisterFunction<Item> register) {
        ...
        PEPPERONI = register.register(createIdentifier(ItemNamesV2.PEPPERONI), () -> new Item(createGroup().food(FoodConstructor.createBuilder(REG_5).build())));
        COFFEE = register.register(createIdentifier(ItemNamesV2.COFFEE), () -> new Drink(createGroup().food(FoodConstructor.createBuilder(REG_5).alwaysEdible().build()).craftRemainder(Items.GLASS_BOTTLE)));
        LEMONADE = register.register(createIdentifier(ItemNamesV2.LEMONADE), () -> new Drink(createGroup().food(FoodConstructor.createBuilder(REG_5).alwaysEdible().build()).craftRemainder(Items.GLASS_BOTTLE)));
        LIMEADE = register.register(createIdentifier(ItemNamesV2.LIMEADE), () -> new Drink(createGroup().food(FoodConstructor.createBuilder(REG_5).alwaysEdible().build()).craftRemainder(Items.GLASS_BOTTLE)));
        SOY_MILK = register.register(createIdentifier(ItemNamesV2.SOY_MILK), () -> new Drink(createGroup().food(FoodConstructor.createBuilder(REG_5).alwaysEdible().build()).craftRemainder(Items.GLASS_BOTTLE)));
        KALE_SMOOTHIE = register.register(createIdentifier(ItemNamesV2.KALE_SMOOTHIE), () -> new Drink(createGroup().food(FoodConstructor.createBuilder(REG_14).alwaysEdible().build()).craftRemainder(Items.GLASS_BOTTLE)));
        FRUIT_SMOOTHIE = register.register(createIdentifier(ItemNamesV2.FRUIT_SMOOTHIE), () -> new Drink(createGroup().food(FoodConstructor.createBuilder(REG_7).alwaysEdible().build()).craftRemainder(Items.GLASS_BOTTLE)));
        CHOCOLATE_MILKSHAKE = register.register(createIdentifier(ItemNamesV2.CHOCOLATE_MILKSHAKE), () -> new Drink(createGroup().food(FoodConstructor.createBuilder(REG_7).alwaysEdible().build()).craftRemainder(Items.GLASS_BOTTLE)));
        BEER = register.register(createIdentifier(ItemNamesV2.BEER), () -> new Drink(createGroup().food(FoodConstructor.createBuilder(REG_7).alwaysEdible().build()).craftRemainder(Items.GLASS_BOTTLE)));
        WINE = register.register(createIdentifier(ItemNamesV2.WINE), () -> new Drink(createGroup().food(FoodConstructor.createBuilder(REG_7).alwaysEdible().build()).craftRemainder(Items.GLASS_BOTTLE)));
        MEAD = register.register(createIdentifier(ItemNamesV2.MEAD), () -> new Drink(createGroup().food(FoodConstructor.createBuilder(REG_7).alwaysEdible().build()).craftRemainder(Items.GLASS_BOTTLE)));
        RUM = register.register(createIdentifier(ItemNamesV2.RUM), () -> new Drink(createGroup().food(FoodConstructor.createBuilder(REG_7).alwaysEdible().build()).craftRemainder(Items.GLASS_BOTTLE)));
        PUMPKIN_SPICE_LATTE = register.register(createIdentifier(ItemNamesV2.PUMPKIN_SPICE_LATTE), () -> new Drink(createGroup().food(FoodConstructor.createBuilder(REG_14).alwaysEdible().build())));
        BEEF_JERKY = register.register(createIdentifier(ItemNamesV2.BEEF_JERKY), () -> new Item(createGroup().food(FoodConstructor.createBuilder(REG_5).build())));
        PORK_JERKY = register.register(createIdentifier(ItemNamesV2.PORK_JERKY), () -> new Item(createGroup().food(FoodConstructor.createBuilder(REG_5).build())));
        ...
        CUCUMBER_SALAD = register.register(createIdentifier(ItemNamesV2.CUCUMBER_SALAD), () -> new Soup(createGroup().food(FoodConstructor.createFoodBowl(REG_10))));
        CAESAR_SALAD = register.register(createIdentifier(ItemNamesV2.CAESAR_SALAD), () -> new Soup(createGroup().food(FoodConstructor.createFoodBowl(REG_10))));
        LEAFY_SALAD = register.register(createIdentifier(ItemNamesV2.LEAFY_SALAD), () -> new Soup(createGroup().food(FoodConstructor.createFoodBowl(REG_10))));
        FRUIT_SALAD = register.register(createIdentifier(ItemNamesV2.FRUIT_SALAD), () -> new Soup(createGroup().food(FoodConstructor.createFoodBowl(REG_10))));
        VEGGIE_SALAD = register.register(createIdentifier(ItemNamesV2.VEGGIE_SALAD), () -> new Soup(createGroup().food(FoodConstructor.createFoodBowl(REG_10))));
        PORK_AND_BEANS = register.register(createIdentifier(ItemNamesV2.PORK_AND_BEANS), () -> new Soup(createGroup().food(FoodConstructor.createFoodBowl(REG_10))));
        OATMEAL = register.register(createIdentifier(ItemNamesV2.OATMEAL), () -> new Soup(createGroup().food(FoodConstructor.createFoodBowl(REG_7))));
        LEEK_SOUP = register.register(createIdentifier(ItemNamesV2.LEEK_SOUP), () -> new Soup(createGroup().food(FoodConstructor.createFoodBowl(REG_7))));
        YOGHURT = register.register(createIdentifier(ItemNamesV2.YOGHURT), () -> new Soup(createGroup().food(FoodConstructor.createFoodBowl(REG_5))));
        SAUCY_CHIPS = register.register(createIdentifier(ItemNamesV2.SAUCY_CHIPS), () -> new Soup(createGroup().food(FoodConstructor.createFoodBowl(REG_7))));
        ...
        TEA = register.register(createIdentifier(ItemNamesV2.TEA), () -> new Drink(createGroup().food(FoodConstructor.createBuilder(REG_5).alwaysEdible().build())));
        ...
        RAW_BACON = register.register(createIdentifier(ItemNamesV2.RAW_BACON), () -> new Item(createGroup().food(FoodConstructor.createBuilder(REG_1).build())));
